...
INSERT INTO roles (role_id, company_id, role_code, role_name, status) VALUES
  ...
  ('r0000001-0001-4000-8000-000000000016', 'c_001', 'cms_operator', 'CMS Operator', 'active'),
...
INSERT INTO role_permissions (role_id, permission_id, status) VALUES
  ...
  ('r0000001-0001-4000-8000-000000000001', '10000000-0001-4000-8000-000000000019', 'active'),
  ('r0000001-0001-4000-8000-000000000001', '10000000-0001-4000-8000-000000000028', 'active'),
  ...
  ('r0000001-0001-4000-8000-000000000001', '10000000-0001-4000-8000-000000000017', 'active'),
  ('r0000001-0001-4000-8000-000000000001', '10000000-0001-4000-8000-000000000018', 'active'),
  ('r0000001-0001-4000-8000-000000000001', '10000000-0001-4000-8000-000000000027', 'active'),
  ...
  ('r0000001-0001-4000-8000-000000000011', '10000000-0001-4000-8000-000000000017', 'active'),
  ('r0000001-0001-4000-8000-000000000011', '10000000-0001-4000-8000-000000000018', 'active'),
  ('r0000001-0001-4000-8000-000000000011', '10000000-0001-4000-8000-000000000027', 'active'),
  ('r0000001-0001-4000-8000-000000000016', '10000000-0001-4000-8000-000000000001', 'active'),
  ('r0000001-0001-4000-8000-000000000016', '10000000-0001-4000-8000-000000000002', 'active'),
  ('r0000001-0001-4000-8000-000000000016', '10000000-0001-4000-8000-000000000003', 'active'),
  ('r0000001-0001-4000-8000-000000000016', '10000000-0001-4000-8000-000000000004', 'active'),
  ('r0000001-0001-4000-8000-000000000016', '10000000-0001-4000-8000-000000000005', 'active'),
  ('r0000001-0001-4000-8000-000000000016', '10000000-0001-4000-8000-000000000006', 'active'),
  ('r0000001-0001-4000-8000-000000000016', '10000000-0001-4000-8000-000000000007', 'active'),
  ('r0000001-0001-4000-8000-000000000016', '10000000-0001-4000-8000-000000000008', 'active'),
  ('r0000001-0001-4000-8000-000000000016', '10000000-0001-4000-8000-000000000009', 'active'),
  ('r0000001-0001-4000-8000-000000000016', '10000000-0001-4000-8000-00000000000a', 'active'),
  ('r0000001-0001-4000-8000-000000000016', '10000000-0001-4000-8000-00000000000b', 'active'),
  ('r0000001-0001-4000-8000-000000000016', '10000000-0001-4000-8000-00000000000c', 'active'),
  ('r0000001-0001-4000-8000-000000000016', '10000000-0001-4000-8000-00000000000d', 'active'),
  ('r0000001-0001-4000-8000-000000000016', '10000000-0001-4000-8000-000000000017', 'active'),
  ...
  ('r0000001-0001-4000-8000-000000000012', '10000000-0001-4000-8000-000000000019', 'active'),
  ('r0000001-0001-4000-8000-000000000012', '10000000-0001-4000-8000-000000000028', 'active'),
  ...
  ('r0000001-0001-4000-8000-000000000012', '10000000-0001-4000-8000-000000000017', 'active'),
  ('r0000001-0001-4000-8000-000000000012', '10000000-0001-4000-8000-000000000018', 'active'),
  ('r0000001-0001-4000-8000-000000000012', '10000000-0001-4000-8000-000000000027', 'active'),
  ...
  ('r0000001-0001-4000-8000-000000000013', '10000000-0001-4000-8000-000000000017', 'active'),
  ...
  ('r0000001-0001-4000-8000-000000000014', '10000000-0001-4000-8000-000000000017', 'active'),
  ...
  ('r0000001-0001-4000-8000-000000000015', '10000000-0001-4000-8000-000000000017', 'active')
...
INSERT INTO memberships (membership_id, user_id, company_id, membership_status) VALUES
  ...
  ('m_106', 'u_cms_operator', 'c_001', 'active'),
...
INSERT INTO membership_roles (membership_id, role_id, status) VALUES
  ...
  ('m_106', 'r0000001-0001-4000-8000-000000000016', 'active'),
...
INSERT INTO membership_effective_responsibilities (company_id, membership_id, responsibility_code, source_type, source_ref_id) VALUES
  ...
  ('c_001', 'm_106', 'workflow_approver:disclosure', 'seed', NULL),
...
INSERT INTO org_unit_memberships (company_id, membership_id, org_unit_id, position_code, status) VALUES
  ...
  ('c_001', 'm_106', 'ou_dept_legal', 'cms_operator', 'active'),
...
SET @rdgp_exists = (
  ...
  WHERE table_schema = DATABASE()
    AND table_name = 'role_default_grant_permissions'
);
SET @rdgp_sql = IF(
  @rdgp_exists > 0,
...
PREPARE rdgp_stmt FROM @rdgp_sql;
EXECUTE rdgp_stmt;
DEALLOCATE PREPARE rdgp_stmt;
