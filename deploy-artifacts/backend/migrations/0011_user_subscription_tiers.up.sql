...
SELECT u.user_id,
       CASE u.user_id
         WHEN 'u_admin_web' THEN 'Premium'
         WHEN 'u_admin_dn' THEN 'Enterprise'
         WHEN 'u_cms_operator' THEN 'Enterprise'
         WHEN 'u_truong_phong' THEN 'Premium'
         WHEN 'u_truong_nhom' THEN 'Premium'
       END AS subscription_tier,
       'migration-0011-override',
       NULL,
       NULL
FROM users u
WHERE u.user_id IN ('u_admin_web', 'u_admin_dn', 'u_cms_operator', 'u_truong_phong', 'u_truong_nhom')
ON DUPLICATE KEY UPDATE
