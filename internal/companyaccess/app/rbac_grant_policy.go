...
var staticGrantPolicies = map[string]PermissionGrantPolicy{
	...
	"cms.record.read":                    policy("cms.record.read", "cms", GrantTierSystemOnly, false, "Read Global CMS Records"),
	"cms.record.write":                   policy("cms.record.write", "cms", GrantTierSystemOnly, false, "Write Global CMS Record drafts"),
	"cms.record.publish":                 policy("cms.record.publish", "cms", GrantTierSystemOnly, false, "Publish/archive Global CMS Records"),
	"cms.record.materialize":             policy("cms.record.materialize", "cms", GrantTierSystemOnly, false, "Materialize Global CMS Records"),
