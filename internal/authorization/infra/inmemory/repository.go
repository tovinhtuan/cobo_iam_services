...
func defaultPolicies() map[string]authapp.ActionPolicy {
	return map[string]authapp.ActionPolicy{
		...
		"disclosure.submit":                  {ActionCode: "disclosure.submit", RequiredPermission: "disclosure.create", ScopeType: "*", WorkflowState: "*", EligibleActor: "*", EffectType: "allow", DenyReasonCode: "permission_denied"},
