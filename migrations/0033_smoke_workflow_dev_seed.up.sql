...
INSERT INTO permissions (permission_id, permission_code, permission_name, module_name, status) VALUES
  ...
  ('10000000-0001-4000-8000-000000000015', 'ad_hoc_alert.admin_review', 'Admin review ad-hoc proposals (deprecated)', 'ad_hoc', 'active'),
  ('10000000-0001-4000-8000-000000000016', 'ad_hoc_alert.process_control', 'Eligible to be assigned as process controller for ad-hoc proposals', 'ad_hoc', 'active'),
